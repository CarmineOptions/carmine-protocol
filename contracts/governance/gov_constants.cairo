...
const QUORUM = 10; // 1/10 of totalSupply required to participate to pass
const TEAM_TOKEN_BALANCE = 1000000000000000000; // 5 * 10^18. Used only in calculation of investor voting power.
