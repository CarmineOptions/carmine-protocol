...
from contracts.constants import (
    ...
    VOLATILITY_UPPER_BOUND, TOKEN_A, TOKEN_B, OPTION_CALL, OPTION_PUT, TRADE_SIDE_LONG,
    TRADE_SIDE_SHORT, get_opposite_side, STRIKE_PRICE_UPPER_BOUND)
...
func get_pool_balance{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        option_type : felt) -> (pool_balance : felt):
...
func get_account_balance{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        account_id : felt, token_type : felt) -> (account_balance : felt):
...
func get_pool_volatility{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        option_type : felt, maturity : felt) -> (pool_volatility : felt):
...
func get_available_options{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        option_type : felt, strike_price : felt, maturity : felt) -> (option_availability : felt):
...
func _calc_new_pool_balance_with_locked_capital{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        side : felt, option_type : felt, current_pool_balance : felt, underlying_price : felt,
        to_be_traded : felt, to_be_minted : felt) -> (pool_balance : felt):
...
func _add_premia_fees{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        side : felt, total_premia_before_fees : felt, total_fees : felt) -> (total_premia : felt):
    assert (side - TRADE_SIDE_SHORT) * (side - TRADE_SIDE_LONG) = 0
...
func _get_vol_update_denominator{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        relative_option_size : felt, side : felt) -> (relative_option_size : felt):
    if side == TRADE_SIDE_LONG:
...
func do_trade{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        account_id : felt, option_type : felt, strike_price : felt, maturity : felt, side : felt,
        option_size : felt) -> (premia : felt):
