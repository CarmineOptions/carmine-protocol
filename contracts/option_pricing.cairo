...
func d1_d2{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
    ...
    let (risk_plus_sigma_squared_half) = Math64x61.add(risk_free_rate_annualized, sigma_squared_half)
    ...
    let (risk_plus_sigma_squared_half_time) = Math64x61.mul(risk_plus_sigma_squared_half, time_till_maturity_annualized)
...
func black_scholes{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
    ...
    let (risk_time_till_maturity) = Math64x61.mul(risk_free_rate_annualized, time_till_maturity_annualized)
    ...
    let (strike_e_neg_risk_time_till_maturity) = Math64x61.mul(strike_price, e_neg_risk_time_till_maturity)
    ...
    let (put_option_value) = Math64x61.add(strike_e_neg_risk_time_till_maturity, neg_underlying_price_call_value)
