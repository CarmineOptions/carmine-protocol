...
namespace LongCallRoundTrip {
    func minimal_round_trip_call{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() {
        ...
        let (volatility: Math64x61_) = IAMM.get_pool_volatility_auto(
            contract_address=amm_addr,
            lptoken_address=lpt_call_addr,
            maturity=expiry,
            strike_price=strike_price
        ...
        assert volatility = 276701161105643274200;  // 288230376151711743900 with old m64x61 codebase

        let (unlocked_capital: Uint256) = IAMM.get_unlocked_capital(contract_address=amm_addr, lptoken_address=lpt_call_addr);

        assert unlocked_capital.low = 4000805494736879460; // 9225453211753752689 with old m64x61 codebase which is 4.000902 ETH

        assert premia = 1803246998050415; // approx 0.0006 ETH
        ...
        assert admin_myETH_balance_1.low = 4999194505263120540;
        ...
        assert call_pool_unlocked_capital_1.low = 4000805494736879460;
        ...
        assert call_volatility_1 = 276701161105643274200;
        ...
        call_pool_balance_1.low = 5000805494736879460;
        ...
        assert pools_pos_val_call_2 = 2303985664805702025;
        ...
        assert admin_myETH_balance_2.low = 6997575597321491381;
        ...
        assert call_pool_unlocked_capital_2.low = 2002424402678508619;
        ...
        assert call_volatility_2 = 276701161105643274200;
        ...
        assert call_pool_balance_2.low = 3002424402678508619;
        ...
        assert pools_pos_val_call_2 = 2294653295906286710;
        ...
        assert premia_2 = 12107224171513991; // approx 0.0049 ETH or 7.22 USD
        ...
        assert admin_myETH_balance_3.low = 7000122172998899130;
        ...
        assert call_pool_unlocked_capital_3.low = 2499877827001100870;
        ...
        assert call_volatility_3 = 253642731013506334700;
        ...
        assert call_pool_balance_3.low = 2999877827001100870;
        ...
        assert pools_pos_val_call_4 = 1147947422721868871;
        ...
        assert admin_myETH_balance_4.low = 7000122172998899130;
        ...
        assert call_pool_unlocked_capital_4.low = 2983748794743036353;
        ...
        assert call_volatility_4 = 253642731013506334700;
        ...
        assert call_pool_balance_4.low = 2983748794743036354;
        ...
        assert admin_myETH_balance_5.low = 7016251205256963646;
        ...
        assert call_pool_unlocked_capital_5.low = 2983748794743036353;
        ...
        assert call_volatility_5 = 253642731013506334700;
        ...
        assert call_pool_balance_5.low = 2983748794743036354;
