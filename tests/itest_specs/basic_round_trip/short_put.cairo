...
namespace ShortPutRoundTrip {
    func minimal_round_trip_put{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() {
        ...
        let (call_pool_value_0) = IAMM.get_value_of_pool_position(
            contract_address=amm_addr,
            lptoken_address=lpt_call_addr
        );
        assert call_pool_value_0 = 0;
        let (put_pool_value_0) = IAMM.get_value_of_pool_position(
            contract_address=amm_addr,
            lptoken_address=lpt_put_addr
        );
        ...
        assert premia = 231107037403980796200; // approx 100.45491895597071 USD...
        ...
        assert admin_myUSD_balance_1.low = 3597219899;
        ...
        assert put_pool_unlocked_capital_1.low = 4902780101;
        ...
        assert put_volatility_1 = 161409010644958576700;
        ...
        assert put_pool_balance_1.low=4902780101; // 4902 USD
        ...
        // Test get_value_of_pool_position
        // Should be 0 since, pool does not have any position
        let (call_pool_value_1) = IAMM.get_value_of_pool_position(
            contract_address=amm_addr,
            lptoken_address=lpt_call_addr
        );
        ...
        let (put_pool_value_1) = IAMM.get_value_of_pool_position(
            contract_address=amm_addr,
            lptoken_address=lpt_put_addr
        );
        assert put_pool_value_1 = 224173826281861372371; // 97.65 USD
        ...
        assert admin_myUSD_balance_2.low = 5579028134;
        ...
        assert put_pool_unlocked_capital_2.low = 2920971866;
        ...
        assert put_volatility_2 = 161409010644958576700;
        ...
        assert put_pool_balance_2.low = 2920971866;
        ...
        // Test get_value_of_pool_position
        // Should be 0 since, pool does not have any position
        let (call_pool_value_2) = IAMM.get_value_of_pool_position(
            contract_address=amm_addr,
            lptoken_address=lpt_call_addr
        );
        ...
        let (put_pool_value_2) = IAMM.get_value_of_pool_position(
            contract_address=amm_addr,
            lptoken_address=lpt_put_addr
        );
        assert put_pool_value_2 = 119305444059707244759;
        ...
        assert premia = 120994132193206546150; // approx 53.9998712746395 USD...
        ...
        assert admin_myUSD_balance_3.low = 6302004622;
        ...
        assert put_pool_unlocked_capital_3.low = 2947995378;
        ...
        assert put_volatility_3 = 195996655783163985900;
        ...
        // 26.99993563731975
        assert put_pool_balance_3.low = 2947995378;
        ...
        // Test get_value_of_pool_position
        // Should be 0 since, pool does not have any position
        let (call_pool_value_3) = IAMM.get_value_of_pool_position(
            contract_address=amm_addr,
            lptoken_address=lpt_call_addr
        );
        ...
        // The value of the pool is in terms of "if the position gets sold off how much gets released to the pool"
        // in this case it is just premia as if the pool would sell the option.
        let (put_pool_value_3) = IAMM.get_value_of_pool_position(
            contract_address=amm_addr,
            lptoken_address=lpt_put_addr
        );
        assert put_pool_value_3 = 60727696241076977173;
        ...
        assert admin_myUSD_balance_4.low = 6302004622;
        ...
        assert put_pool_unlocked_capital_4.low = 2972995378;
        ...
        assert put_volatility_4 = 195996655783163985900;
        ...
        assert put_pool_balance_4.low = 2972995378;
        ...
        // Test get_value_of_pool_position
        // Should be 0 since, pool does not have any position
        let (call_pool_value_4) = IAMM.get_value_of_pool_position(
            contract_address=amm_addr,
            lptoken_address=lpt_call_addr
        );
        ...
        let (put_pool_value_4) = IAMM.get_value_of_pool_position(
            contract_address=amm_addr,
            lptoken_address=lpt_put_addr
        );
        ...
        assert admin_myUSD_balance_5.low = 7027004622;
        ...
        assert put_pool_unlocked_capital_5.low = 2972995378;
        ...
        assert put_volatility_5 = 195996655783163985900;
        ...
        assert put_pool_balance_5.low = 2972995378;
        ...
        // Test get_value_of_pool_position
        // Should be 0 since, pool does not have any position
        let (call_pool_value_5) = IAMM.get_value_of_pool_position(
            contract_address=amm_addr,
            lptoken_address=lpt_call_addr
        );
        ...
        // Pool has no position at this moment
        let (put_pool_value_5) = IAMM.get_value_of_pool_position(
            contract_address=amm_addr,
            lptoken_address=lpt_put_addr
        );
