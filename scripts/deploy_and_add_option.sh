...
OPTION_TYPE=0
# STRIKE_PRICE=2305843009213693952000 # 1000
...
MATURITY=1673567999 # Thu Jan 12 2023 23:59:59 GMT+0000
# MATURITY=1679615999 # Thu Mar 23 2023 23:59:59 GMT+0000
OPTION_SIDE=0
...
starknet deploy --gateway_url $GATEWAY_URL --feeder_gateway_url $FEEDER_GATEWAY_URL --inputs 123456789 1234 18 0 0 $AMM_ADDRESS $AMM_ADDRESS $QUOTE_TOKEN_ADDRESS $BASE_TOKEN_ADDRESS $OPTION_TYPE $STRIKE_PRICE $MATURITY $OPTION_SIDE --class_hash $CLASS_HASH --max_fee 415160854059520000000
