...
build/ammcontract.cairo: contracts/amm.cairo contracts/liquidity_pool.cairo contracts/view.cairo tests/proxy_mock.cairo
	mkdir -p build
	cat tests/proxy_mock.cairo contracts/amm.cairo contracts/liquidity_pool.cairo contracts/view.cairo > $@
