...
build/ammcontract.cairo: tests/proxy_mock.cairo contracts/amm.cairo contracts/liquidity_pool.cairo contracts/options.cairo contracts/view.cairo contracts/state.cairo
	mkdir -p build
	cat $+ > $@
